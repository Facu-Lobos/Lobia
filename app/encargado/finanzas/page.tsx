...
export default async function EncargadoFinanzasPage({
  searchParams,
}: {
    ...
    <div>
      ...
      <div className="mt-4 flex items-center justify-between">
        ...
        <div className="flex gap-2 text-sm">
          <Link
            href={`/encargado/finanzas?month=${monthParam(prevMonth)}`}
            className="rounded-md border border-border px-2 py-1 hover:border-primary"
          >
            ← Anterior
          </Link>
          <Link
            href={`/encargado/finanzas?month=${monthParam(nextMonth)}`}
            className="rounded-md border border-border px-2 py-1 hover:border-primary"
          >
            Siguiente →
          </Link>
