...
export default async function EncargadoEspecialidadesPage({
  searchParams,
}: {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-muted">
        Lista compartida por todas las instituciones. Podés agregar las que
        falten; eliminarlas es sólo para administradores (podría afectar
