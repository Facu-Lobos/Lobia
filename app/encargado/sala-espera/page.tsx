  ...
  return (
    <div>
      ...
      <div className="mt-4 flex items-center gap-3 text-sm">
        <Link
          href={`/encargado/sala-espera?date=${dayParam(prevDay)}${qs}`}
        ...
        <Link
          href={`/encargado/sala-espera?date=${dayParam(nextDay)}${qs}`}
          className="rounded-md border border-border px-2 py-1 hover:border-primary"
        >
          Día siguiente →
        </Link>
      ...
      <div className="mt-6">
        <WaitingRoom
          ...
          returnTo={`/encargado/sala-espera?date=${dayParam(day)}${qs}`}
